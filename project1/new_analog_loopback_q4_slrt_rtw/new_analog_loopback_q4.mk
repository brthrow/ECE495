...
MODEL           = new_analog_loopback_q4
MODULES         = new_analog_loopback_q4_capi.c new_analog_loopback_q4_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = new_analog_loopback_q4.mk
...
S_FUNCTIONS     = adquanserq8.c encquanserq8.c daquanserq8.c doquanserq8.c
S_FUNCTIONS_LIB = 
NUMST           = 3
TID01EQ         = 1
NCSTATES        = 0
...
MODELLIB                  = new_analog_loopback_q4lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = new_analog_loopback_q4_ref.rsp
MODELREF_INC_PATH         = 
