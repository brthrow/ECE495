...
#ifndef RTW_HEADER_downloaded_from_web_h_
#define RTW_HEADER_downloaded_from_web_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
#include "rtw_modelmap.h"
#ifndef downloaded_from_web_COMMON_INCLUDES_
# define downloaded_from_web_COMMON_INCLUDES_
...
#endif                                 /* downloaded_from_web_COMMON_INCLUDES_ */

#include "downloaded_from_web_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_downloaded_from_web    RT_MODEL_downloaded_from_web_T

/* Definition for use in the target main file */
#define downloaded_from_web_rtModel    RT_MODEL_downloaded_from_web_T
...
typedef struct {
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_n;                 /* '<S2>/S-Function' */

  int_T Q4AD_IWORK[2];                 /* '<Root>/Q4 AD' */
} DW_downloaded_from_web_T;

/* Backward compatible GRT Identifiers */
#define rtB                            downloaded_from_web_B
#define BlockIO                        B_downloaded_from_web_T
#define rtP                            downloaded_from_web_P
#define Parameters                     P_downloaded_from_web_T
#define rtDWork                        downloaded_from_web_DW
#define D_Work                         DW_downloaded_from_web_T

/* Parameters (auto storage) */
struct P_downloaded_from_web_T_ {
  ...
  real_T Q4Enc_P12;                    /* Expression: pciSlot
                                        * Referenced by: '<Root>/Q4 Enc '
                                        */
  real_T PulseGenerator_Amp;           /* Expression: 4
...
struct tag_RTM_downloaded_from_web_T {
  const char_T *path;
...
extern P_downloaded_from_web_T downloaded_from_web_P;

/* Block signals (auto storage) */
extern B_downloaded_from_web_T downloaded_from_web_B;

/* Block states (auto storage) */
extern DW_downloaded_from_web_T downloaded_from_web_DW;

/*====================*
 * External functions *
 *====================*/
extern downloaded_from_web_rtModel *downloaded_from_web(void);
...
extern RT_MODEL_downloaded_from_web_T *const downloaded_from_web_M;
 ...
 *
 * '<Root>' : 'downloaded_from_web'
 * '<S1>'   : 'downloaded_from_web/Scope 1'
 * '<S2>'   : 'downloaded_from_web/Scope 2'
 */
#endif                                 /* RTW_HEADER_downloaded_from_web_h_ */
