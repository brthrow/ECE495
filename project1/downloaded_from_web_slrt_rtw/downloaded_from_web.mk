...
MODEL           = downloaded_from_web
MODULES         = downloaded_from_web_capi.c downloaded_from_web_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = downloaded_from_web.mk
...
MODELLIB                  = downloaded_from_weblib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = downloaded_from_web_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\downloaded_from_web_slrt_rtw
